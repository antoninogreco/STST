...
``` 
This procedure can generate dynamic stimuli like the following. For comparison, there are shown videos generated by randomizing the phase in the spatiotemporal frequency domain (STPS). 
